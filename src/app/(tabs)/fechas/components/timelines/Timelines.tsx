    ...
    <Tabs className="flex flex-col gap-5" defaultValue="events">
      <div className="flex w-full items-center justify-between">
        ...
        <TabsList className="flex items-center gap-2 bg-white">
          <TabsTrigger value="events" className="text-sm px-4 h-9 bg-primary/70 cursor-pointer text-white rounded-md data-[state=active]:bg-primary data-[state=active]:text-white">
            Eventos
          </TabsTrigger>
